...
/***/ "./node_modules/raw-loader/index.js!./src/app/components/auth-header/auth-header.component.html":
/*!*********************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/components/auth-header/auth-header.component.html ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
module.exports = "<nav class=\"navbar navbar-expand-lg navbar-transparent  navbar-absolute fixed-top\">\n    <div class=\"container-fluid\">\n        <div class=\"navbar-wrapper\">\n          <a class=\"navbar-brand\" href=\"javascript:void(0)\">{{getTitle()}}</a>\n        </div>\n        <button mat-raised-button class=\"navbar-toggler\" type=\"button\" (click)=\"sidebarToggle()\">\n            <span class=\"sr-only\">Toggle navigation</span>\n            <span class=\"navbar-toggler-icon icon-bar\"></span>\n            <span class=\"navbar-toggler-icon icon-bar\"></span>\n            <span class=\"navbar-toggler-icon icon-bar\"></span>\n        </button>\n        <div class=\"collapse navbar-collapse justify-content-end\" id=\"navigation\">\n            <!-- <form class=\"navbar-form\">\n                <div class=\"input-group no-border\">\n                    <input type=\"text\" value=\"\" class=\"form-control\" placeholder=\"Search...\">\n                    <button mat-raised-button type=\"submit\" class=\"btn btn-white btn-round btn-just-icon\">\n                        <i class=\"material-icons\">search</i>\n                        <div class=\"ripple-container\"></div>\n                    </button>\n                </div>\n            </form> -->\n            <ul class=\"navbar-nav\">\n                <li class=\"nav-item dropdown\">\n                    <a class=\"nav-link\" href=\"javascript:void(0)\" id=\"UserMenuLink\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">\n                        <i class=\"material-icons\">settings</i>\n                        <p>\n                            <span class=\"d-lg-none d-md-block\">Account</span>\n                        </p>\n                    </a>\n                    <div class=\"dropdown-menu dropdown-menu-right\" aria-labelledby=\"UserMenuLink\">\n                        <a class=\"dropdown-item\" [routerLink]=\"['/admin/user-profile']\">Profile</a>\n                        <a class=\"dropdown-item\" href=\"#\" (click)=\"logout()\">Logout</a>\n                    </div>\n                </li>\n            </ul>\n        </div>\n    </div>\n</nav>\n"
...
module.exports = "<div class=\"wrapper\">\n    <div class=\"sidebar\" data-color=\"theme-light\" data-background-color=\"white\" data-image=\"./assets/img/sidebar-1.jpg\">\n        <app-sidebar></app-sidebar>\n        <div class=\"sidebar-background\" style=\"background-image: url(./assets/img/sidebar-4.jpg)\"></div>\n    </div>\n    <div class=\"main-panel\">\n        <app-navbar></app-navbar>\n        <router-outlet></router-outlet>\n        <div>\n            <!-- <app-footer></app-footer> -->\n        </div>\n    </div>\n</div>\n"
...
var APIService = /** @class */ (function () {
    ...
    APIService.prototype.saveToken = function (token, userId, userType, username, authCode, expiryDate, billDate, planCode, emailApiType, userHeaderDetails, mainUserId, req) {
        if (emailApiType === void 0) { emailApiType = ''; }
        if (mainUserId === void 0) { mainUserId = ""; }
        this.token = token;
        this.userId = userId;
        ...
        var expirySession = new Date();
        localStorage.setItem("selectedUserId", "");
        var stayLoggedIn = localStorage.getItem("stayLoggedIn") || sessionStorage.getItem("stayLoggedIn");
        if (!stayLoggedIn) {
    ...
    APIService.prototype.getKeyFromStorage = function (key) {
    ...
    //function to get key from storages
    APIService.prototype.removeKeyFromStorage = function (key) {
        if (localStorage.getItem(key)) {
    ...
    APIService.prototype.request = function (method, type, data) {
        var _this = this;
        var base;
        if (method === 'post') {
            base = this.http.post(_config__WEBPACK_IMPORTED_MODULE_4__["serverUrl"] + ("/api/" + type), data);
        }
        else {
            base = this.http.get(_config__WEBPACK_IMPORTED_MODULE_4__["serverUrl"] + ("/api/" + type), { headers: { Authorization: "Bearer " + this.getToken() } });
        }
        var request = base.pipe(Object(rxjs_operators_map__WEBPACK_IMPORTED_MODULE_2__["map"])(function (response) {
            if (response.data && response.data.token) {
                ...
                if (data.userType === response.data.userType || (data.userType == "AdminWeb" && response.data.userType == "TeamMember")) {
                    var _a = response.data, token = _a.token, userId = _a.userId, userType = _a.userType, username = _a.username, authCode = _a.authCode, expiryDate = _a.expiryDate, billDate = _a.billDate, planCode = _a.planCode, emailApiType = _a.emailApiType, userHeaderDetails = _a.userHeaderDetails, mainUserId = _a.mainUserId;
                    _this.saveToken(token, userId, userType, username, authCode, expiryDate, billDate, planCode, emailApiType, userHeaderDetails, mainUserId, data);
                    return response;
                }
                else {
    ...
    APIService.prototype.syncMailInBackground = function (userId, authCode, emailApiType, limit, folder, offset) {
        if (emailApiType === void 0) { emailApiType = "gmail"; }
        if (limit === void 0) { limit = 20; }
        if (folder === void 0) { folder = 'inbox'; }
        ...
        var userEmail = localStorage.getItem("username") || sessionStorage.getItem("username");
        var messages = [];
        this.apiRequest('post', 'email/getThreadsWithDetails', req_vars).subscribe(function (result) {
    ...
    APIService.prototype.getFolderCount = function (userId, authCode, emailApiType, folder) {
        if (emailApiType === void 0) { emailApiType = 'gmail'; }
        if (folder === void 0) { folder = 'INBOX'; }
        var req_vars = {
            userId: userId,
        ...
        this.apiRequest('post', 'email/getFolderCount', req_vars).subscribe(function (result) {
            if (result.status == "error") {
                console.log(result.data);
...
/***/ "./src/app/components/auth-header/auth-header.component.css":
/*!******************************************************************!*\
  !*** ./src/app/components/auth-header/auth-header.component.css ***!
  \******************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/auth-header/auth-header.component.ts":
/*!*****************************************************************!*\
  !*** ./src/app/components/auth-header/auth-header.component.ts ***!
  \*****************************************************************/
...
var AuthHeaderComponent = /** @class */ (function () {
    ...
    AuthHeaderComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./auth-header.component.html */ "./node_modules/raw-loader/index.js!./src/app/components/auth-header/auth-header.component.html"),
            styles: [__webpack_require__(/*! ./auth-header.component.css */ "./src/app/components/auth-header/auth-header.component.css")]
        }),
...
/* harmony import */ var _auth_header_auth_header_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./auth-header/auth-header.component */ "./src/app/components/auth-header/auth-header.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(location, element, router, api) {
    ...
    NavbarComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common__WEBPACK_IMPORTED_MODULE_2__["Location"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], app_api_service__WEBPACK_IMPORTED_MODULE_4__["APIService"]])
    ], NavbarComponent);
...
module.exports = ".logo-img{\n    width: 70px !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = __webpack_require__(/*! /opt/lampp/htdocs/git/kethan/frontend/src/main.ts */"./src/main.ts");
